...
.LM34:
	...
	.p2align 3
.L13:
	.stabn	68,0,88,.LM35-.LFBB3
.LM35:
	xorl	%edi, %edi
	call	monitor
	jmp	.L13
.L16:
	.stabn	68,0,74,.LM36-.LFBB3
.LM36:
...
.LM40:
	...
	leaq	32(%rsp), %rax
	movq	%rax, 16(%rsp)
	.stabn	68,0,80,.LM41-.LFBB3
.LM41:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,81,.LM42-.LFBB3
.LM42:
	movq	%rbx, %rdi
	movq	%rsp, %rsi
	call	vcprintf
	.stabn	68,0,82,.LM43-.LFBB3
.LM43:
	movl	$.LC12, %edi
	xorl	%eax, %eax
	call	cprintf
...
.LM46:
	leaq	224(%rsp), %rax
	.stabn	68,0,98,.LM47-.LFBB4
.LM47:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC14, %edi
	.stabn	68,0,97,.LM48-.LFBB4
.LM48:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	movl	$24, (%rsp)
...
.LM50:
	...
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,100,.LM51-.LFBB4
.LM51:
	xorl	%eax, %eax
	movl	$.LC12, %edi
	call	cprintf
	.stabn	68,0,102,.LM52-.LFBB4
.LM52:
	movq	24(%rsp), %rax
	xorq	%fs:40, %rax
	jne	.L21
