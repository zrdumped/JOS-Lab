...
int sys_env_exec_new_env(envid_t env);
...
int sys_e1000_transmit(char* data, int length);
int sys_e1000_receive(char* data);
int sys_e1000_mac(char* mac);
